...
#%%
x1 = np.random.standard_t(8,size=50000)
x2 = np.random.normal(2,size=50000)
x3 = np.random.normal(2,size=50000)
...
X['y'] = X['x1_transform']*5 + X['x2_transform'] + X['x12_transform']*0.2 + X['x3_transform']*2 \
